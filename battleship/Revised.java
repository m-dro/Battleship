...
public class Revised {
    ...
    CoordinateManager p1Manager = new CoordinateManager(p1Gamefield, p1Ships);
    CoordinateManager p2Manager = new CoordinateManager(p2Gamefield, p2Ships);
...
/*        System.out.printf("%s, place your ships on the game field\n\n", player.getName());
    ...
    public boolean checkShot(String shot, Player player) {
        ...
        if (opponentGamefield[row][column] == 'X') {
            manager.showGameField(playerGamefield);
            return anyShipsLeft(opponentGamefield);
        } else if (opponentGamefield[row][column] == 'O'){
